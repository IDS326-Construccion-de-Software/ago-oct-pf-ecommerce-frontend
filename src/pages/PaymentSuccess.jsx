...
const PaymentSuccess = () => {
  ...
  if (!paymentData) {
    // Optional: Redirect to home or show an error if no payment data is found
    return (
      <div className="payment-success-container">
        <div className="payment-success-card">
          <h1>Error</h1>
          <p>No se encontraron datos de la transacción.</p>
          <button className="another-payment-button" onClick={() => navigate('/')}>Volver al inicio</button>
        </div>
      </div>
    );
  }
    ...
    <div className="payment-success-container">
      <div className="payment-success-card">
        ...
        <p className="confirmation-email">Recibirás un correo de confirmación con los detalles de tu compra</p>
                <button className="another-payment-button" onClick={() => navigate('/')}>Realizar otro pago</button>
